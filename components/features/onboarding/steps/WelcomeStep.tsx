  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      <button
        ...
        className="w-full p-4 rounded-xl border border-[var(--ds-border-strong)] hover:border-purple-500/50 hover:bg-[var(--ds-bg-surface)] transition-all text-left group"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold dark:text-white text-[var(--ds-text-primary)] mb-1">Configurar do zero</h3>
            <p className="text-sm text-[var(--ds-text-muted)] mb-2">
