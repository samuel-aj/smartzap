...
export function AdvancedFlowPanel({
  ...
  return (
    <div data-advanced-panel-root="true" className="fixed inset-y-0 right-0 w-[600px] bg-zinc-900 border-l border-[var(--ds-border-default)] shadow-2xl z-50 overflow-auto">
      <div className="sticky top-0 bg-zinc-900 border-b border-[var(--ds-border-default)] p-4 flex items-center justify-between">
        <div>
          <div className="text-lg font-semibold dark:text-white text-[var(--ds-text-primary)]">Modo Avançado</div>
          ...
          {selectedScreen && (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-surface)] px-3 py-2">
                <div>
                  <div className="text-xs font-medium text-[var(--ds-text-secondary)]">Terminal</div>
              ...
              <div className="rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-surface)] px-3 py-3 space-y-2">
                <div className="text-xs font-medium text-[var(--ds-text-secondary)]">Ir para (próxima tela)</div>
